...
def FixCornerPositions(imgReal, points):
    ...
    while True:
        ...
        if int(points[0][0] + space) > xMouse > int(points[0][0] - space) and int(points[0][1] + space) > yMouse > int(
                points[0][1] - space):
            points[0] = xMouse, yMouse
        elif int(points[1][0] + space) > xMouse > int(points[1][0] - space) and int(
                points[1][1] + space) > yMouse > int(points[1][1] - space):
            points[1] = xMouse, yMouse
        elif int(points[2][0] + space) > xMouse > int(points[2][0] - space) and int(
                points[2][1] + space) > yMouse > int(points[2][1] - space):
            points[2] = xMouse, yMouse
        elif int(points[3][0] + space) > xMouse > int(points[3][0] - space) and int(
                points[3][1] + space) > yMouse > int(points[3][1] - space):
